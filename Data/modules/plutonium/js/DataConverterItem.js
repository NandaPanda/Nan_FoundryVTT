...
class DataConverterItem extends DataConverter {
	...
	static async pHasItemSideLoadedEffects (actor, item) {
		...
		return (await DataConverter._pGetEffectsRawSideLoaded_(fauxGeneric, {propBrew: "foundryVariant", fnLoadJson: Vetools.pGetItemSideData, propJson: "variant"}))?.length > 0;
	}
	...
	static async pGetItemItemEffects (actor, item, sheetItem, {additionalData, img} = {}) {
		...
		const effectsRawVariant = await DataConverter._pGetEffectsRawSideLoaded_(fauxGeneric, {propBrew: "foundryVariant", fnLoadJson: Vetools.pGetItemSideData, propJson: "variant"});
