...
import { applyTokenDamage, checkNearby, completeItemRoll, doOverTimeEffect, findNearby, getChanges, getConcentrationEffect, getDistanceSimple, getTraitMult, midiRenderRoll, MQfromActorUuid, MQfromUuid, reportMidiCriticalFlags } from './module/utils.js';
...
Hooks.once('ready', function () {
	...
	//@ts-ignore
	if (installedModules.get("levels") && typeof _levels !== "undefined")
	...
	*/
	if (installedModules.get("dae")) {
		...
		initDAE().then(value => { if (!value)
			console.error(`midi-qol | initDae settomgs failed`); });
	}
}
